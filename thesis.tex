...
% Macro definition!
\newcommand{\LN}{{Lightning Network}}
\newcommand{\CLN}{Core Lightning}

% Start the chapter from 0, if you
% like C you know that this make sense!
% if you share this idea, I do!
