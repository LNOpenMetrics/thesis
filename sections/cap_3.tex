...
a feature. Where most of the time in order to address a well-known problem a data 
driven analysis on a group of nodes is required in order to emphasize the
...
on gossip data which any node can with at least one public channel  
have access to. An example of this kind of analysis is described in \cite{lngossip}
