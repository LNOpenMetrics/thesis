...
% FIXME: add the description of the figure here!
...
% FIXME: talk a little how the interface implement the basic messagge that a 
% any kind of metrics needs.
